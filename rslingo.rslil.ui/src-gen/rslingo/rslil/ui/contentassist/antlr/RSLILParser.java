		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPlannedScheduleAccess().getStartAssignment_2(), "rule__PlannedSchedule__StartAssignment_2");
					put(grammarAccess.getPlannedScheduleAccess().getEndAssignment_4(), "rule__PlannedSchedule__EndAssignment_4");
					put(grammarAccess.getActualScheduleAccess().getStartAssignment_2(), "rule__ActualSchedule__StartAssignment_2");
					put(grammarAccess.getActualScheduleAccess().getEndAssignment_4(), "rule__ActualSchedule__EndAssignment_4");
					...
					put(grammarAccess.getOrganizationsAccess().getCustomerAssignment_2(), "rule__Organizations__CustomerAssignment_2");
					put(grammarAccess.getOrganizationsAccess().getSupplierAssignment_4(), "rule__Organizations__SupplierAssignment_4");
					put(grammarAccess.getOrganizationsAccess().getPartnersAssignment_6(), "rule__Organizations__PartnersAssignment_6");
