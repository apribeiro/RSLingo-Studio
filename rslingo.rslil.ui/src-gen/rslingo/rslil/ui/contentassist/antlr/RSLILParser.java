		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSystemLevelAccess().getGroup(), "rule__SystemLevel__Group__0");
					put(grammarAccess.getSystemLevelAccess().getGroup_1(), "rule__SystemLevel__Group_1__0");
					...
					put(grammarAccess.getPackageProjectAccess().getSystemLevelAssignment_8(), "rule__PackageProject__SystemLevelAssignment_8");
					...
					put(grammarAccess.getPackageSystemAccess().getSystemLevelAssignment_4(), "rule__PackageSystem__SystemLevelAssignment_4");
					put(grammarAccess.getSystemLevelAccess().getSystemsAssignment_1_0(), "rule__SystemLevel__SystemsAssignment_1_0");
					put(grammarAccess.getSystemLevelAccess().getEntitiesAssignment_1_1(), "rule__SystemLevel__EntitiesAssignment_1_1");
					put(grammarAccess.getSystemLevelAccess().getActorsAssignment_1_2(), "rule__SystemLevel__ActorsAssignment_1_2");
					put(grammarAccess.getSystemLevelAccess().getUseCasesAssignment_1_3(), "rule__SystemLevel__UseCasesAssignment_1_3");
					put(grammarAccess.getSystemLevelAccess().getFrsAssignment_1_4(), "rule__SystemLevel__FrsAssignment_1_4");
					put(grammarAccess.getSystemLevelAccess().getQrsAssignment_1_5(), "rule__SystemLevel__QrsAssignment_1_5");
					put(grammarAccess.getSystemLevelAccess().getConstraintsAssignment_1_6(), "rule__SystemLevel__ConstraintsAssignment_1_6");
