		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatusAccess().getValueAlternatives_0(), "rule__Status__ValueAlternatives_0");
					...
					put(grammarAccess.getProjectAccess().getStatusAssignment_11_1(), "rule__Project__StatusAssignment_11_1");
					...
					put(grammarAccess.getStatusAccess().getValueAssignment(), "rule__Status__ValueAssignment");
