 ...
 * </p>
 * <ul>
 *   <li>{@link rslingo.rslil.rSLIL.UseCase#getId <em>Id</em>}</li>
...
public interface UseCase extends EObject
{
   ...
   * @see #setId(String)
   * @see rslingo.rslil.rSLIL.RSLILPackage#getUseCase_Id()
   * @model
   * @generated
   */
  String getId();
  ...
  /**
   * Sets the value of the '{@link rslingo.rslil.rSLIL.UseCase#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
