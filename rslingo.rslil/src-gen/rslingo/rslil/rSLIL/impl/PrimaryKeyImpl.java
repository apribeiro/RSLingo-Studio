 ...
 * </p>
 * <ul>
 *   <li>{@link rslingo.rslil.rSLIL.impl.PrimaryKeyImpl#getRefTo <em>Ref To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimaryKeyImpl extends MinimalEObjectImpl.Container implements PrimaryKey
{
  ...
  {
    return RSLILPackage.Literals.PRIMARY_KEY;
  }
  ...
  public NotificationChain basicSetRefTo(RefAttribute newRefTo, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLILPackage.PRIMARY_KEY__REF_TO, oldRefTo, newRefTo);
  ...
  public void setRefTo(RefAttribute newRefTo)
  {
    if (newRefTo != refTo)
    {
      ...
      if (refTo != null)
        msgs = ((InternalEObject)refTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLILPackage.PRIMARY_KEY__REF_TO, null, msgs);
      if (newRefTo != null)
        msgs = ((InternalEObject)newRefTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLILPackage.PRIMARY_KEY__REF_TO, null, msgs);
      msgs = basicSetRefTo(newRefTo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLILPackage.PRIMARY_KEY__REF_TO, newRefTo, newRefTo));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RSLILPackage.PRIMARY_KEY__REF_TO:
