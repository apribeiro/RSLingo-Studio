...
public class ComposedByImpl extends MinimalEObjectImpl.Container implements ComposedBy
{
  ...
  public Goal getRefGoal()
  {
    if (refGoal != null && refGoal.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RSLILPackage.COMPOSED_BY__REF_GOAL, oldRefGoal, refGoal));
      }
    }
    return refGoal;
  }
  ...
  public void setRefGoal(Goal newRefGoal)
  {
    ...
    refGoal = newRefGoal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLILPackage.COMPOSED_BY__REF_GOAL, oldRefGoal, refGoal));
  }
