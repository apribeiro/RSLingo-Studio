 ...
 * </p>
 * <ul>
 *   <li>{@link rslingo.rslil.rSLIL.impl.CheckImpl#getName <em>Name</em>}</li>
 *   <li>{@link rslingo.rslil.rSLIL.impl.CheckImpl#getCheckExpression <em>Check Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CheckImpl extends MinimalEObjectImpl.Container implements Check
{
  ...
  {
    return RSLILPackage.Literals.CHECK;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLILPackage.CHECK__NAME, oldName, name));
  }
  ...
  public void setCheckExpression(String newCheckExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLILPackage.CHECK__CHECK_EXPRESSION, oldCheckExpression, checkExpression));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RSLILPackage.CHECK__NAME:
        return getName();
      case RSLILPackage.CHECK__CHECK_EXPRESSION:
