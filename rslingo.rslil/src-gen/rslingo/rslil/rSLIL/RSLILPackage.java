...
public interface RSLILPackage extends EPackage
{
   ...
   * @ordered
   */
  int USE_CASE__EXTENSIONN_POINTS = 5;
   ...
   * @ordered
   */
  int USE_CASE__ACTOR_INITIATES = 8;
   ...
   * @ordered
   */
  int USE_CASE__PRE_CONDITIONS = 10;
   ...
   * @ordered
   */
  int USE_CASE__POST_CONDITIONS = 11;
